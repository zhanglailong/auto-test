...
public class AutoScript implements Serializable {
	...
	/**状态*/
	@Excel(name = "状态-0正常、1录制、2下发、3执行、4录制失败、5停止失败、6下发失败", width = 15)
    @ApiModelProperty(value = "状态-0正常、1录制、2下发、3执行、4录制失败、5停止失败、6下发失败")
    ...
    private java.lang.String executeNodeId;
    /**录制节点id*/
    ...
    /**ipfs文件名称*/
    @Excel(name = "ipfs文件名称", width = 15)
    @ApiModelProperty(value = "ipfs文件名称")
