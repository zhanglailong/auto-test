 ...
 */
@Mapper
public interface IAutoRunningProjectService extends IService<AutoRunningProject> {
    /**
     * 自动化项目添加
     * @param runningProject 项目
     * @return true
     */
    Boolean addAuToRunningProject(AutoRunningProject runningProject);
     ...
     * @return 没有返回值
     */
    Page<RunningProjectInfo> queryPageList(Page<RunningProjectInfo> page, String projectName, String projectCode, String createTime, String projectId,String createBy);
     ...
     * @return name
     */
    List<AutoRunningProject> getNameByProjectId(String id);
     ...
     * @return 没有返回值
     */
    List<AutoRunningProject> getProjectInfo();
     ...
     */
    AutoRunningProject getRunningProject(String id);

    List<AutoRunningProject> getCasesTree();
}
