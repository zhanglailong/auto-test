  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/autoNodes/autoNodes/add",
          edit: "/autoNodes/autoNodes/edit",
          queryById: "/autoNodes/autoNodes/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'nodeName','clientIp','state','remark','idel'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'nodeName','clientIp','state','remark','idel'))
      },
    }
  }
</script>