 ...
 */
@Mapper
public interface AuToRunningCaseMapper extends BaseMapper<AuToRunningCase> {
    /**
     * 获取列表信息
     ...
     * */
    List<AuToRunningCase> getTestCopyDataById(@Param("caseId") String[] caseId);
    ...
    @Select("SELECT * FROM running_case WHERE test_task_id=#{taskId} AND del_flag='0' ")
